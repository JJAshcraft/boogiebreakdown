const projects = [
  ...
  },
  {
    title: "Lambda Notes",
    description:
      "This is a full-stack application build using React/Redux for the frontend, and Firebase for the backend. Authorization is handled via Firebase Auth, and the Database is a Firebase Realtime Database. Note: You must login to see the current notes, which are not yet designated for individual users...notes are viewable/editable as a collection which any logged in user has access to. This app features CSV export and theme-switching.",
  ...
  },
  {
    ...
    description:
      "This is a fully-responsive site for S and J Architects. Learning moment: Utilizing GSAP for animations.",
  ...
  },
  {
    ...
    description:
      "This is a basic React application built similar to a todo app, but as a packing guide. ",
    tech: ["React", "HTML/CSS"],
    link: "https://frontend-project-42d1e.firebaseapp.com/",
    frontend_repo: "https://github.com/JJAshcraft/front-end-project-week",
    backend_repo: "",
